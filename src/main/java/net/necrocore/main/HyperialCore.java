...
public class HyperialCore extends JavaPlugin implements Listener, PluginMessageListener{
	
	public static String GetServer;
	public static String[] serverList;
	public static SQL mysql;
	public static String name = "&8&l[&3&lHYPERIAL&8&l]";
	private static HyperialCore instance;
	...
	public void onDisable(){
		...
		SQLCrates.onDisableSavePlayer();
		SQLLevels.onDisableSavePlayer();
		ConsoleCommandSender console = Bukkit.getConsoleSender();
	...
	public void registerListeners(){
		...
		manager.registerEvents(new SQLLevels(this), this);
		manager.registerEvents(new SQLCrates(this), this);
	...
	public static HyperialCore getInstance(){
	     return instance;
	}
